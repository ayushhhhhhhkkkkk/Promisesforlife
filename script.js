...
setTimeout(() => typeWriter(document.getElementById("landingSub"), "Tap a balloon to know mere dil ki baat..."), 1200);
...
function showFinal() {
  ...
  typeWriter(document.getElementById("finalText"),
   "I may have missed some promises here, but I'll never miss a chance to prove them to you. ❤️");
}
